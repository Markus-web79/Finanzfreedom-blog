    ...
    <main style={styles.page}>
      ...
      <section style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Exchange Traded Funds einfach erklärt – von Grundlagen bis konkrete
          ETF-Auswahl.
        </p>
      </section>
      ...
      <section style={styles.grid}>
        ...
        <Link href="/etfs/etf-grundlagen" style={styles.card}>
          ...
          <p style={styles.cardText}>
            Was sind ETFs, wie funktionieren sie und warum sind sie ideal für
            Einsteiger?
          </p>
        ...
        <Link href="/etfs/msci-emerging-markets" style={styles.card}>
          ...
          <p style={styles.cardText}>
            Schwellenländer-ETFs: höhere Chancen, höhere Risiken – verständlich
            erklärt.
          </p>
          <span style={styles.cta}>Zum Artikel</span>
        </Link>
        ...
        <Link href="/etfs/all-world-etfs" style={styles.card}>
          ...
          <p style={styles.cardText}>
            Ein ETF für die ganze Welt – Unterschiede zu MSCI World & Co. klar
            erklärt.
          </p>
          <span style={styles.cta}>Zum Artikel</span>
        </Link>
